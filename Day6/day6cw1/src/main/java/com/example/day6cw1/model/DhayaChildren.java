...
public class DhayaChildren {
    ...
    public DhayaChildren() {
    }
    public DhayaChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
